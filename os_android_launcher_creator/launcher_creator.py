...
def create_launcher_icons(custom_android_project_path,
    ...
    Args:
        ...
        launcher_obj_list: a list containing the LauncherObj. Every LauncherObj contains the path to the launcher and and a path to the destination files to be copied
    ...
    """
    inst = bp.LauncherCreatorBP(custom_android_project_path, launcher_obj_list, shortcut_keys_to_open_image_asset, launcher_resize_percent, launcher_background_color_hex, skip_if_output_dir_exists)
